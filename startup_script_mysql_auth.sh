...
wget "https://raw.githubusercontent.com/alessandroArrighi/progettoCloud/main/databases/auth/creazione_db.sql"

sudo mysql --user=root --password=root < creazione_db.sql 
